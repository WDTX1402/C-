...
{
public:
    double real, imag, irra;
    Complex(double real = 0.0, double imag = 0.0, double irra = 0.0) : real(real), imag(imag), irra(irra) {}
    ...
    {
        return Complex(real + other.real, imag + other.imag, irra + other.irra);
    }
